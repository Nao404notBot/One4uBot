...
# ========================= CONSTANTS ============================
UNAPPROVED_MSG = (
    "`You didn't read my bio (￣ヘ￣;).`\n"
    "`I think I got brain damage and Heart Attack (Don't PM me (╯°□°）╯︵ ┻━┻)`\n"
    "`so, please don't spam my PM..`\n"
    "`I will be slow to reply if you are not important.`\n\n"
